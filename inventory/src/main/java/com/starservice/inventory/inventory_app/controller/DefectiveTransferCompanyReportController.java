...
import com.starservice.inventory.inventory_app.service.DefectiveTransferCompanyReportService;
...
public class DefectiveTransferCompanyReportController {
    ...
    private final DefectiveTransferCompanyReportService defectiveTransferCompanyReportService;

    @GetMapping("/download")
    public ResponseEntity<ByteArrayResource> generateDefectiveTransferCompanyReport(
        ...
        String filename = defectiveTransferCompanyReportService.getDefectiveTransferCompanyReportFileName(fromDate, toDate);
