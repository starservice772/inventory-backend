...
import com.starservice.inventory.inventory_app.service.SaleService;
...
public class SaleController {
    ...
    public ResponseEntity<ApiResponse<?>> saveSale(@RequestBody SaleRequestDTO request) {

        try {
            String message = saleService.save(request);
